function QiniuJsSDK() {
    ...
    },this.createSync = function (url, id)
    {
        var res;
        $.ajax(
        {
            ...
            {
                resquest.setRequestHeader("If-Modified-Since", "0");
            }
        });
        return res;
    ...
    this.uploader = function(b)
    {
        ...
        j.bind("BeforeUpload", function (c, d)
        {
            ...
            var e = function(c, d, e)
            {
                ...
                var cc = a.createSync(a.uptoken_url, d.name);
                a.token = cc.uptoken;
        ...
        function(c) {
            return function(d, e, g) {
                ...
                if (f = f ? f: k.ctx) {
                    ...
                    var q = "https://up.qbox.me/mkfile/" + e.size + l + o,
                    r = a.createAjax();
                    r.open("POST", q, !0),
