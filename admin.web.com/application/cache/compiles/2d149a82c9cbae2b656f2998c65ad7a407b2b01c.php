<?php /* Smarty version Smarty-3.1.19, created on 2016-01-20 09:47:08
         compiled from "application/views/zh_cn/order/undeal.tpl" */ ?>
<?php /*%%SmartyHeaderCode:240574272569ee71c011876-17966712%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '033dfa55ec65231b8d939c2b7d285294f06ef1e1' => 
    array (
      0 => 'application/views/zh_cn/order/undeal.tpl',
      1 => 1450687817,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '240574272569ee71c011876-17966712',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_569ee71c0a4690_94848498',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_569ee71c0a4690_94848498')) {function content_569ee71c0a4690_94848498($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/data0/htdocs/merchant.imt.com/application/third_party/smarty/plugins/modifier.date_format.php';
?><html>
<head>
    <meta charset="utf-8">
    <title>未处理订单</title>
                        ...
                        <div class="wrap-right-content">
                            <div class="wrap-right-title">
                                ...
                                <ul class="clearfix">
                                    ...
                                    <li <?php if ($_smarty_tpl->tpl_vars['type']->value=="undeal") {?>class='current'<?php }?>><a href="/order/undeal">未处理订单</a></li>
                                </ul>
                            </div>
...
?>
                                                <li><a href="/order/undeal?p=<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['foo']['index'];?>
"><?php echo $_smarty_tpl->getVariable('smarty')->value['section']['foo']['index'];?>
                                        ...
                                        <div class="wrap-word-pagetap">
                                            <a href="<?php if ($_smarty_tpl->tpl_vars['page']->value==1) {?>javascript:;<?php } else { ?>/order/undeal?p=<?php echo $_smarty_tpl->tpl_vars['page']->value-1;?>
<?php }?>" class="word-pagetap-prev">上一页</a>
                                            <a href="/order/undeal?p=<?php echo $_smarty_tpl->tpl_vars['page']->value+1;?>
...
&nbsp;<?php echo $_smarty_tpl->tpl_vars['value']->value['shoppingAddr']['lastName'];?>
                                            ...
                                            <div class="list-float" style="width:12%;word-break:break-all;text-align: center;"><a href="/order/undeal?stype=email&search=<?php echo $_smarty_tpl->tpl_vars['value']->value['shoppingAddr']['email'];?>
&type=&submit=true"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['value']->value['shoppingAddr']['email'])===null||$tmp==='' ? "-" : $tmp);?>
</a></div>
                                            <div class="list-float" style="width:10%;word-break:break-all;text-align: center;"><?php echo $_smarty_tpl->tpl_vars['value']->value['shoppingAddr']['phone'];?>
</div>
                                            ...
                                            <div class="list-float" style="text-align: center;">
                                                <label for=""><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['value']->value['payTime'],'%Y/%m/%d %H:%M:%S');?>
</label>
                                            </div>
