<?php /* Smarty version Smarty-3.1.19, created on 2016-08-11 23:44:46
        ...
        <div class="wrap-right">
            <div class="wrap-right-content">
                ...
                <div class="base-infor-wrap">
                    <form method="post" action="<?php if (!isset($_smarty_tpl->tpl_vars['tagInfo']->value)) {?>/category/doaddtag.html<?php } else { ?>/category/domanagetag.html<?php }?>">
                        <ul>
                            <li class="clearfix">
                                <span>标签名称</span>
                                <input type="text" name="tagName" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['tagInfo']->value['tag_name'])===null||$tmp==='' ? '' : $tmp);?>
" />
                            </li>
                            <li class="clearfix">
                                <span>优&nbsp;&nbsp;先&nbsp;&nbsp;级</span>
                                <input type="text" name="priority" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['tagInfo']->value['priority'])===null||$tmp==='' ? '' : $tmp);?>
" />
                            </li>
                            <?php if (isset($_smarty_tpl->tpl_vars['tagInfo']->value)) {?>
                            <li class="clearfix">
                                <span>是否使用</span>
                                <label for="">禁用:<input style="float: none;"  type="radio" name="status" value="0" <?php if ($_smarty_tpl->tpl_vars['tagInfo']->value['status']==0) {?>checked<?php }?>></label>
                                <label for="">使用:<input style="float: none;" type="radio" name="status" value="1" <?php if ($_smarty_tpl->tpl_vars['tagInfo']->value['status']==1) {?>checked<?php }?>></label>
                            </li>
                            <?php }?>
                        </ul>
                        <div>
                            <input type="submit" value="<?php if (!isset($_smarty_tpl->tpl_vars['tagInfo']->value)) {?>添&nbsp;&nbsp;&nbsp;加<?php } else { ?>修&nbsp;&nbsp;&nbsp;改<?php }?>">
