							...
							<div class="new-commodity-block1 new-commodity-common">
								...
								<div class="new-commodity-inner">
									...
									<div class="clearfix new-commodity-input">
										...
										<input type="text" name="seoKeyword" autocomplete="off" />
									</div>
									<div class="clearfix new-commodity-input">
										<span>seo:Description</span>
										<input type="text" name="seoDescription" autocomplete="off" />
									</div>
									<div class="clearfix new-commodity-radio">
										<span>商品品类</span>
										<p class="clearfix">
											<{foreach $catalog as $cate}>
	                                        <label><input type="radio" name="catalog" class="catalog" value="<{$cate.id}>"><{$cate.name}></label>
											<{/foreach}>
										</p>
									</div>
