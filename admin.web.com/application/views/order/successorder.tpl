                        ...
                        <div class="wrap-right-content">
                            <div class="wrap-right-title">
                                ...
                                <ul class="clearfix">
                                    ...
                                    <li <{if $type eq "successOrder" }>class='current'<{/if}>><a href="/order?type=successOrder">成功订单</a></li>
                                    ...
                                    <div class="wrap-word-page clearfix">
                                        <div class="wrap-word-pagechange">
                                            ...
                                            <ul class="wrap-page-list">
                                                ...
                                                <li><a href="/order?type=successOrder&p=<{$smarty.section.foo.index}>"><{$smarty.section.foo.index}></a></li>
                                                <{/section}>
                                            </ul>
                                        </div>
                                        <div class="wrap-word-pagetap">
                                            <a href="<{if $page eq 1}>javascript:;<{else}>/order?type=successOrder&p=<{$page - 1}><{/if}>" class="word-pagetap-prev">上一页</a>
                                            <a href="/order?type=successOrder&p=<{$page + 1}>" class="word-pagetap-next">下一页</a>
                                        </div>
                                    </div>
                                ...
                                <form action="">
                                    <ul>
                                        ...
                                        <li class="clearfix" id='<{$value.orderId}>'>
                                            ...
                                            <div class="list-float" style="width:12%;word-break:break-all;text-align: center;"><a href="/order?stype=email&search=<{$value.shoppingAddr.email}>&type=successOrder&submit=true"><{$value.shoppingAddr.email|default:"-"}></a></div>
