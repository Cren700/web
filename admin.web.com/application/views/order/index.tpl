                    ...
                    <div class="wrap-right-parent">
                        <div class="wrap-right-content">
                            <div class="wrap-right-title">
                                <h2>所有订单</h2>
                                <ul class="clearfix">
                                    <li <{if $type eq "" || $type eq "index"}>class='current'<{/if}>><a href="/order" >所有订单</a></li>
                                    ...
                                    <div class="wrap-word-page clearfix">
                                        <div class="wrap-word-pagechange">
                                            ...
                                            <ul class="wrap-page-list">
                                                ...
                                                <li><a href="/order?p=<{$smarty.section.foo.index}>"><{$smarty.section.foo.index}></a></li>
                                                <{/section}>
                                            </ul>
                                        </div>
                                        <div class="wrap-word-pagetap">
                                            <a href="<{if $page eq 1}>javascript:;<{else}>/order?p=<{$page - 1}><{/if}>" class="word-pagetap-prev">上一页</a>
                                            <a href="/order?p=<{$page + 1}>" class="word-pagetap-next">下一页</a>
                                        </div>
                                    </div>
                                ...
                                <form action="">
                                    <ul>
                                        ...
                                        <li class="clearfix" id='<{$value.orderId}>'>
                                            ...
                                            <div class="list-float" style="width:10%;word-break:break-all;text-align: center;"><{$value.shoppingAddr.phone|default:"-"}></div>
                                            ...
                                            <div class="operation-list list-float">
                                                ...
                                                <ul class="window-btn">
                                                    ...
                                                    <{else if $value.status eq 2}>
                                                        ...
                                                        <li><a href="/order/linkmer?orderid=<{$value.orderId}>">联系买家</a></li>
                                                    <{else if $value.status eq 3}>
                                                        <li><a href="/order/details?orderid=<{$value.orderId}>">查看</a></li>
                                                        <li data-num=2 data-flag=true class='<{$value.orderId}>'><a href="javascript:;">退款</a></li>
                                                        <li><a href="/order/linkmer?orderid=<{$value.orderId}>">联系买家</a></li>
                                                    <{else if $value.status eq 4}>
                                                        <li><a href="/order/details?orderid=<{$value.orderId}>">查看</a></li>
                                                        <li data-num=2 data-flag=true class='<{$value.orderId}>'><a href="javascript:;">退款</a></li>
                                                        <li><a href="/order/linkmer?orderid=<{$value.orderId}>">联系买家</a></li>
                                                    <{else}>
